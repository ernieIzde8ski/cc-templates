...
def work_in(dirname=...) -> collections.abc.Generator[None, Any, None]:
...
type _BlankFunction = typing.Callable[..., object]

def simple_filter(filter_function: _BlankFunction) -> type[Extension]:
